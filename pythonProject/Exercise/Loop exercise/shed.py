...
class shed:
    ...
    def __init__(self):
        ...
        self.petrol_available ='not available'
        self.diesel_available ='not available'
        self.petrol_92_available ='not available'
        self.petrol_95_available = 'not available'
        self.auto_diesel_available = 'not available'
        self.super_diesel_available = 'not available'
        self.Price=0
        self.petrol_92_price_1L=0
        self.petrol_95_price_1L=0
        self.super_diesel_price_1L=0
        self.auto_diesel_price_1L=0
        self.Total_Liters=0
        self.diesel_price=0
        self.petrol_price=0
        self.petrol_litters=0
        self.diesel_litters=0

        self.petrol_92_volume=0
        self.petrol_95_volume=0
        self.super_diesel_volume=0
        self.auto_diesel_volume=0
    ...
    def fuel_available(self):
        ...
        if self.petrol_92_volume == 0:
            self.petrol_92_available = 'available'
        if self.petrol_95_volume > 0:
            petrol_95_available = 'available'
        if self.petrol_95_volume > 0 and self.petrol_92_volume > 0 :
            petrol_available = 'available'
        if self.auto_diesel_volume > 0:
            auto_diesel_available = 'available'
        if self.super_diesel_volume > 0:
            super_diesel_available= 'available'
        if self.auto_diesel_volume > 0 and self.super_diesel_volume > 0 :
            diesel_available = 'available'

    def run(self):
        while True:
            day1.fuel_available()

            point1_text = f'1).Petrol - {self.petrol_available}'.ljust(30)
            point2_text = f'2).Diesel - {self.diesel_available}'
                ...
                if Option.isdigit() :
                    ...
                    if Option<5:
                        if Option==1 or Option==2 :
                            ...
                            if Option==1:
                                self.petrol_price = input('Price :')
                                if self.petrol_price.isdigit():
                                    petrol_price=int(petrol_price)
                                    print('Petrol'.center(50))
                                    print('1). 92 Octane'.ljust(30,'_'),f'{Available}')
                                    print('2). 95 Octane'.ljust(30,'_'), f'{Available}')
                                    print('3).Exit\n')
