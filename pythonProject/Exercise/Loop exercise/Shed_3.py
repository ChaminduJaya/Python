...
class shed:
    ...
    def decide_petrol_available(petrol_92_volume,petrol_95_volume ):
        if petrol_95_volume > 0 or petrol_92_volume > 0 :
            return "Available"
        return "not Available"

    def decide_diesel_available(auto_diesel_volume,super_diesel_volume):
        if auto_diesel_volume > 0 or super_diesel_volume > 0 :
            return "Available"
        return "not Available"
    def decide_petrol_92_available(petrol_92_volume ):
        if  petrol_92_volume > 0 :
            return "Available"
        return "not Available"
    def decide_petrol_95_available(petrol_92_volume ):
        if  petrol_95_volume > 0 :
            return "Available"
        return "not Available"

    def decide_auto_diesel_available(auto_diesel_volume ):
        if  auto_diesel_volume > 0 :
            return "Available"
        return "not Available"
    def decide_super_diesel_available(super_diesel_volume ):
        if  super_diesel_volume > 0 :
            return "Available"
        return "not Available"
    while True:
        print(petrol_92_volume)
        petrol_available=decide_petrol_available(petrol_92_volume, petrol_95_volume)
        diesel_available=decide_diesel_available(auto_diesel_volume, super_diesel_volume)
                    ...
                    if Option==1 or Option==2 :
                        ...
                        if Option==1:
                            ...
                            if petrol_price.isdigit():
                                ...
                                print('1). 92 Octane'.ljust(30,'_'),f'{decide_petrol_92_available(petrol_92_volume)}')
                                print('2). 95 Octane'.ljust(30,'_'),f'{decide_petrol_95_available(petrol_95_volume)}')
                                print('3).Exit\n')
                                    ...
                                    if petrol_type.isdigit():
                                        ...
                                        if petrol_type < 4:
                                            if petrol_type == 1:
                                                ...
                                                if Available=='available':
                                                    petrol_95_volume=cal_new_fuel_volume(petrol_95_volume,petrol_litters)
                                            #else:
                            ...
                            if diesel_price.isdigit():
                                ...
                                print('1). Super Diesel'.ljust(30, '_'), f'{decide_super_diesel_available(super_diesel_volume)}')
                                print('2). Auto Diesel'.ljust(30, '_'), f'{decide_auto_diesel_available(auto_diesel_volume)}')
                                print('3).Exit\n')
